...
# Stock name mapping (Unicode escaped for safe transfer)
...
def handle_message(event):
    ...
    if user_text.isdigit() or (".TW" in user_text) or (".TWO" in user_text):
        ...
        line_bot_api.reply_message(
            event.reply_token, 
            TextSendMessage(text="Hello! I am your stock analyst. Send a stock ticker (e.g., 2330) and I will provide technical signals!")
        )
